...
class Ship:
    ...
    def draw(self):
        self.window.screen.blit(
            pygame.image.load('ship.png'), (self.x, self.y))
...
class Alien:
    ...
    def draw(self):
        self.window.screen.blit(pygame.image.load(
            'alien.png'), (self.x, self.y))
...
class Bullet:
    ...
    def draw(self):
        pygame.draw.rect(self.window.screen, (254, 52, 110),
